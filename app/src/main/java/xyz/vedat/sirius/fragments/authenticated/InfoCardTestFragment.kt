...
class InfoCardTestFragment : Fragment(R.layout.fragment_information_card) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.informationCard.observe(viewLifecycleOwner) {
            view.findViewById<TextView>(R.id.srs_information_card_random_text).text = it.student.id
        }
    }
}
